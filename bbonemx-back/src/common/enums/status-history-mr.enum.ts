...
registerEnumType(StatusHistoryMR, {
    ...
    description: 'Estados posibles del historial de materiales de una solicitud de materiales',
    valuesMap: {
        PENDING_PURCHASE_REQUEST: { description: 'Pendiente de solicitud de compra' },
        PENDING_QUOTATION: { description: 'Pendiente de cotización' },
        PENDING_APPROVAL_QUOTATION: { description: 'Pendiente de aprobación de cotización' },
        PENDING_SUPPLIER_REGISTRATION: { description: 'Pendiente de alta de proveedor' },
