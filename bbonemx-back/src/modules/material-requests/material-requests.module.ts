...
@Module({
    imports: [TypeOrmModule.forFeature([MaterialRequest, MaterialRequestItem]), MaterialsModule, SparePartsModule],
    providers: [MaterialRequestsRepository, MaterialRequestItemsRepository, MaterialRequestsService, MaterialRequestsResolver],
