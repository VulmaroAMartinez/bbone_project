...
export class ScheduleFiltersInput {
  ...
  @Field(() => ID, {
    nullable: true,
    description: 'Filtrar por turno (quién trabaja en turno X)',
  })
  @IsOptional()
  @IsUUID()
  shiftId?: string;
  ...
  @Field(() => Int, {
    nullable: true,
    description: 'Filtrar por semana del año',
  })
  @IsOptional()
  @IsInt()
  @Min(1)
  ...
  @Field(() => ID, {
    nullable: true,
    description: 'Filtrar por motivo de ausencia',
  })
  @IsOptional()
  @IsUUID()
  ...
  @Field({
    nullable: true,
    description: 'Solo días de trabajo (excluir ausencias)',
  })
  @IsOptional()
