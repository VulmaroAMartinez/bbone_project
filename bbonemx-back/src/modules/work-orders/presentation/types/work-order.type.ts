...
export class WorkOrderType {
  ...
  @Field(() => ID, { nullable: true }) subAreaId?: string;
  @Field(() => SubAreaType, { nullable: true }) subArea?: SubAreaType;
  @Field(() => ID) requesterId: string;
  @Field(() => UserType) requester: UserType;
  @Field(() => ID, { nullable: true }) assignedShiftId?: string;
  @Field(() => ShiftType, { nullable: true }) assignedShift?: ShiftType;
  ...
  @Field({ nullable: true }) breakdownDescription?: string;
  @Field({ nullable: true }) cause?: string;
  @Field({ nullable: true }) actionTaken?: string;
  @Field({ nullable: true }) toolsUsed?: string;
  @Field({ nullable: true }) customSparePart?: string;
  @Field({ nullable: true }) customMaterial?: string;
  @Field(() => Int, { nullable: true }) downtimeMinutes?: number;
  @Field({ nullable: true }) pauseReason?: string;
  @Field(() => Int) functionalTimeMinutes: number;
  @Field({ nullable: true }) lastResumedAt?: Date;
  @Field(() => ID, { nullable: true }) findingId?: string;
  @Field(() => ID, { nullable: true }) preventiveTaskId?: string;
