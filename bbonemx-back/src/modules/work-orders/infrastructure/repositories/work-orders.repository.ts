...
const SORT_FIELD_MAP: Record<WorkOrderSortField, string> = {
  [WorkOrderSortField.CREATED_AT]: 'wo.createdAt',
  [WorkOrderSortField.UPDATED_AT]: 'wo.updatedAt',
  [WorkOrderSortField.SCHEDULED_DATE]: 'wo.scheduledDate',
  [WorkOrderSortField.PRIORITY]: 'wo.priority',
  [WorkOrderSortField.STATUS]: 'wo.status',
  [WorkOrderSortField.FOLIO]: 'wo.folio',
};
