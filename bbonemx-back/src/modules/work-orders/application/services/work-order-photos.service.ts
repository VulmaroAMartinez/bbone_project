...
export class WorkOrderPhotosService {
  constructor(
    private readonly workOrderPhotosRepository: WorkOrderPhotosRepository,
  ) {}
  ...
  async findByWorkOrderAndPhotoType(
    workOrderId: string,
    photoType: PhotoType,
  ): Promise<WorkOrderPhoto[]> {
    return this.workOrderPhotosRepository.findByWorkOrderAndPhotoType(
      workOrderId,
      photoType,
    );
  }
  ...
  async countByType(
    ...
    return this.workOrderPhotosRepository.countByWorkOrderIdAndType(
      workOrderId,
      photoType,
    );
  }
