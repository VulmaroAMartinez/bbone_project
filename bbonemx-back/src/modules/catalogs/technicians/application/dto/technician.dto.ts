...
export class CreateTechnicianInput {
  ...
  @IsString({
    message:
      'El nombre del contacto de emergencia debe ser una cadena de texto',
  })
  @Length(2, 200, {
    message:
      'El nombre del contacto de emergencia debe tener entre 2 y 200 caracteres',
  })
  ...
  @IsString({
    message:
      'El teléfono del contacto de emergencia debe ser una cadena de texto',
  })
  @Length(10, 10, {
    message: 'El teléfono del contacto de emergencia debe tener 10 caracteres',
  })
  emergencyContactPhone: string;

  @Field()
  @IsNotEmpty({
    message: 'La relación del contacto de emergencia es requerida',
  })
  @IsString({
    message:
      'La relación del contacto de emergencia debe ser una cadena de texto',
  })
  @Length(2, 50, {
    message:
      'La relación del contacto de emergencia debe tener entre 2 y 50 caracteres',
  })
  ...
  @Length(2, 200, {
    message: 'La dirección debe tener entre 2 y 200 caracteres',
  })
  address: string;
  ...
  @Length(2, 100, {
    message: 'La educación debe tener entre 2 y 100 caracteres',
  })
  education: string;
  ...
  @IsString({
    message: 'El tamaño de la pantalón debe ser una cadena de texto',
  })
  pantsSize: string;
  ...
  @IsString({
    message: 'El tamaño de la zapatilla debe ser una cadena de texto',
  })
  shoeSize: string;
  ...
  @Length(2, 100, {
    message: 'La ruta de transporte debe tener entre 2 y 100 caracteres',
  })
...
@InputType()
export class UpdateTechnicianInput extends PartialType(
  OmitType(CreateTechnicianInput, ['userId']),
) {
  @Field(() => ID)
