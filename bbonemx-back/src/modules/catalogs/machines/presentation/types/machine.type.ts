...
export class MachineType {
    ...
    @Field(() => ID, { nullable: true, description: 'ID del área directa (null si pertenece a sub-área)' })
    areaId?: string;

    @Field(() => AreaType, { nullable: true, description: 'Área directa (null si pertenece a sub-área)' })
    area?: AreaType;

    // ── Relación con Sub-área (ahora nullable) ──
    @Field(() => ID, { nullable: true, description: 'ID de la sub-área (null si pertenece directamente al área)' })
    subAreaId?: string;

    @Field(() => SubAreaType, { nullable: true, description: 'Sub-área (null si pertenece directamente al área)' })
    subArea?: SubAreaType;
