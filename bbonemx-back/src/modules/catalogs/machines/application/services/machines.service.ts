...
export class MachinesService {
  ...
  async update(id: string, input: UpdateMachineInput): Promise<Machine | null> {
    ...
    await this.validateAreaSubAreaXor(
      data.areaId ?? finalAreaId,
      data.subAreaId ?? finalSubAreaId,
    );
  ...
  private async validateAreaSubAreaXor(
    areaId?: string | null,
    ...
    if (hasArea && hasSubArea) {
      throw new BadRequestException(
        'No puede especificar areaId y subAreaId simultáneamente. Use solo uno.',
      );
    }
