...
export type FindingBasicFragment = { __typename?: 'Finding', id: string, folio: string, description: string, photoPath?: string | null, status: FindingStatus, createdAt: string, photos?: Array<(
    { __typename?: 'FindingPhoto' }
