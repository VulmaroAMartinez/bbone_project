...
const documents: Documents = {
    ...
    "\n  mutation AddMaterialRequestPhoto($input: CreateMaterialRequestPhotoInput!) {\n    addMaterialRequestPhoto(input: $input) {\n      id\n      filePath\n      fileName\n      mimeType\n      uploadedAt\n    }\n  }\n": types.AddMaterialRequestPhotoDocument,
    "\n  mutation RemoveMaterialRequestPhoto($id: ID!) {\n    removeMaterialRequestPhoto(id: $id)\n  }\n": types.RemoveMaterialRequestPhotoDocument,
    ...
    "\n  query GetTechIdsForShift($filters: ScheduleFiltersInput!) {\n    technicianSchedulesFiltered(filters: $filters) {\n      technicianId\n    }\n  }\n": types.GetTechIdsForShiftDocument,
