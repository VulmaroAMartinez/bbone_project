...
import { Search, Plus, Package, X, ChevronLeft, ChevronRight } from 'lucide-react';
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
import { CATEGORY_LABELS } from '@/components/material-requests/material-request.constants';
